<%@ Page Language="C#" AutoEventWireup="true" CodeFile="careless-driving.aspx.cs" Inherits="En_careless_driving" %>
...
<li><a href="careless-driving.aspx" title="Careless Driving" class="seractive01">Careless Driving</a></li>	
...
<li><a href="drink-driving.aspx" title="Drink Driving">Drink Driving</a></li>
		...
		<div class="container">
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
							 <h2>Careless Driving</h2>
                        <p><img src="images/Careless_driving_image.jpg" class="img-responsive" alt=""></p>
                        <p align="justify">The offence of careless driving is committed when you drive without due care and attention or without reasonable consideration for other persons using the road or place.</p>
                        <p align="justify">In some cases, a driver may, be given the opportunity to attend a Driver Improvement Course on the basis that the police feel the driver would benefit from attending such a course as opposed to prosecuting him.</p>
                        <p align="justify">The maximum sanction that can be imposed by the court is a financial penalty subject to your means, and the court must endorse your driving licence with between 3 and 9 penalty points and or consider imposing a discretionary disqualification. </p>
                        <p align="justify">If you need free initial advice and assistance call Middleton Solicitors Driving Defence Team for free on 0800 XX XXX.</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 footer_li" id="Div1">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="employment.aspx" title="Employment">Employment</a></li>								
						<li><a href="housing_disrepair.aspx" title="Housing Disrepair">Housing Disrepair</a></li>
                        <li><a href="careless-driving.aspx" title="Careless Driving" class="seractive">Careless Driving</a></li>	
                        <li><a href="dangerous-driving.aspx" title="Dangerous Driving">Dangerous Driving</a></li>
                        <li><a href="drink-driving.aspx" title="Drink Driving">Drink Driving</a></li>
