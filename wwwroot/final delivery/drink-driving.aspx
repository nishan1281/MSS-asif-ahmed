			...
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
                        ...
                        <p align="justify">The offence of drink driving is committed if a person drives or attempts to drive a motor vehicle on a road, or other place after consuming so much alcohol that the proportion of alcohol in his breath, blood or urine exceeds the prescribed limit.</p>
                        ...
                        <p align="justify">If that person commits a second offence within a three year period of the original offence, the starting point for the this offence is not only a disqualification is 36 months minimum but the courts must consider custody as an option in the event of pleading guilty or being found guilty after a trial.</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 footer_li" id="Div1">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="careless-driving.aspx" title="Careless Driving">Careless Driving</a></li>
                        <li><a href="dangerous-driving.aspx" title="Dangerous Driving">Dangerous Driving</a></li>	      
                        <li><a href="drink-driving.aspx" title="Drink Driving" class="seractive">Drink Driving</a></li>
