<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sports-law.aspx.cs" Inherits="En_Sports_law" %>
...
<head>
    ...
    <title>Middleton Solicitors - Sports Law Solicitors Liverpool | Best UK Sports Lawyers</title>

    <meta name="description" content="Middleton Solicitors company’s Sports Solicitors are experts in the UK Sports Law. We are the one of the leading Sports Law firms in the UK, advice and govern the sports person, sports clubs and individuals." />
    <meta name="keywords" content="sports law solicitors liverpool ,sports lawyers in liverpool, best sports lawyer in UK, leading Sports Law firms in UK, best sport lawyer liverpool" />
		...
		<div class="container">
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
							 <h2>Sports Law</h2>
                        <p><img src="images/service5.jpg" class="img-responsive" alt=""></p>
                      <p align="justify">Here at Middleton Solicitors we have a specialist team dealing with all aspects of Sports Law. We offer extremely competitive prices as well as a fast and efficient service.</p>
                     <div class="clearfix"></div>

                       <ul class="service_li"><li>We offer the following services</li>
                            <li>Drafting and negotiation of sports contracts</li>
                            <li>Dispute Resolution</li>
                            <li>Regulatory – Player Transfers, Financial Fair Play</li>						  
                            <li> Sponsorship Agreements, Image Rights, Terms and Conditions, Merchandising, Endorsements</li>
                           <li>FA Regulations</li>
                      </ul> 
                      
                      <p>The fees for each service are flexible and vary accordingly.</p>
                      
              
                         <h2>Sports Law Team</h2>
                        <p>
                         Alan Middleton - Partner and FA Registered Intermediary <br />
Viki Barry - Legal Executive<br />
James Conning - Solicitor<br />
Paul Smith - Trainee Solicitor<br />
Hannah Cox - Administrative Assistant
...
<uc1:popup ID ="popup1" runat ="server" />
                ...
                <div class="col-sm-3 pull-right">
                    <div class="categories">
                    	...
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury"  >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance " >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law"  class="seractive01">Sports Law</a></li>         
                        <li><a href="commercial-and-residential-leases.aspx" title="Residential and Commercial Property">Residential and Commercial Property</a></li>          
                        <li><a href="wills-probate-trusts.aspx" title="Wills, Probate and Trusts" >Wills, Probate and Trusts</a></li>
						<li><a href="employment.aspx" title="Employment">Employment</a></li>								
						<li><a href="housing_disrepair.aspx" title="Housing Disrepair">Housing Disrepair</a></li>
		...
		<div class="container">             
            <div class="row">
                <div class="col-sm-3 footer_ab" id="tab_view">
                    ...
                    <a href="about-us.aspx" title ="View More" class="btn btn-default">View More</a>
                </div>
                ...
                <div class="col-sm-3 footer_li" id="tab_view">
                    ...
                    <ul class="list-unstyled">
                    	...
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law" class="seractive">Sports Law</a></li>         
                        <li><a href="commercial-and-residential-leases.aspx" title="Residential and Commercial Property" >Residential and Commercial Property</a></li>          
                        <li><a href="wills-probate-trusts.aspx" title="Wills, Probate and Trusts" >Wills, Probate and Trusts</a></li>                           
                        <li><a href="employment.aspx" title="Employment">Employment</a></li>								
						<li><a href="housing_disrepair.aspx" title="Housing Disrepair">Housing Disrepair</a></li>
