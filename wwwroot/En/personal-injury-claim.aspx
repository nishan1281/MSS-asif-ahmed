<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal-injury-claim.aspx.cs" Inherits="En_Default" %>
...
<link rel="icon" href="images/favicon.ico" type="image/x-icon">
        ...
        <title>Personal injury solicitors Liverpool, UK | Accident Claims Compensation Service - Middleton Solicitors</title>
			...
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
                      ...
                      <p align="justify">Middleton Solicitors has a specialist team working on personal injury claims. We handle all types of personal injury cases, so whether it's a trip or fall, accident in the workplace or a motor vehicle collision please call us to discuss your requirements. We have thousands of satisfied clients and we would like you to be one of those.</p>
                     <div class="clearfix"></div>
                      ...
                      <p align="justify">Middleton Solicitors are here to help you; we can arrange everything to help get your life back on track after an injury, from arranging car hire whilst your car is being repaired to physiotherapy which will aid your recovery.</p> 
...
<uc1:popup ID="popup1" runat="server"/>
                ...
                <div class="col-sm-3 pull-right">
                    <div class="categories">
                        ...
                        <li><a href="debt-recovery.aspx" title="Debt Recovery">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury"  class="seractive01">Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law">Sports Law</a></li>         
                        <li><a href="commercial-and-residential-leases.aspx" title="Residential and Commercial Property">Residential and Commercial Property</a></li>          
                        <li><a href="wills-probate-trusts.aspx" title="Wills, Probate and Trusts" >Wills, Probate and Trusts</a></li> 
            ...
            <div class="row">
                ...
                <div class="col-sm-3 footer_li" id="tab_view">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="debt-recovery.aspx" title="Debt Recovery">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" class="seractive">Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law">Sports Law</a></li>         
                        <li><a href="commercial-and-residential-leases.aspx" title="Residential and Commercial Property">Residential and Commercial Property</a></li>          
                        <li><a href="wills-probate-trusts.aspx" title="Wills, Probate and Trusts" >Wills, Probate and Trusts</a></li>                           
