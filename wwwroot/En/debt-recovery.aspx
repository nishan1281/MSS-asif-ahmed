<%@ Page Language="C#" AutoEventWireup="true" CodeFile="debt-recovery.aspx.cs" Inherits="En_debt_recovery" %>
...
<link rel="icon" href="images/favicon.ico" type="image/x-icon">
         ...
         <title>Debt Recovery Solicitors Liverpool | Commercial Debt Recovery– Middleton Solicitors UK</title>
		...
		<div class="container">
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
							 <h2>Debt Recovery</h2>
                        <p><img src="images/service6.jpg" class="img-responsive" alt=""></p>
                     
                      <p align="justify">As Debt Recovery specialists Middleton Solicitors can help your cash flow and reduce your bad debts. Our team is very experienced and can deal with all matters which may arise in Debt Recovery processes including contested and non contested recoveries.</p>

                       <ul class="service_li">
                            <li></li>
                            <li>Fixed Fees</li>
                            <li> Fixed costs of issuing a claim</li>
              ...
              <div class="wrap">
                ...
                <div class="col-sm-3 pull-right">
                    <div class="categories">
                        ...
                        <li><a href="debt-recovery.aspx" title="Debt Recovery" class="seractive01">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law">Sports Law</a></li>         
		...
		<div class="container">             
            <div class="row">
                ...
                <div class="col-sm-3 footer_li" id="tab_view">
                    ...
                    <ul class="list-unstyled">
                    	 <li><a href="commercial-law.aspx" title="Commercial Law">Commercial Law</a></li>
                        <li><a href="debt-recovery.aspx" title="Debt Recovery" class="seractive">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
                        <li><a href="sports-law.aspx" title="Sports Law">Sports Law</a></li>         
