<%@ Page Language="C#" AutoEventWireup="true" CodeFile="commercial-law.aspx.cs" Inherits="En_Commercial_law" %>
...
<link rel="icon" href="images/favicon.ico" type="image/x-icon">
          ...
          <title>Commercial Litigation | Commercial litigation attorney | Business Litigations</title>
          <meta name="description" content="We at Middleton Solicitors in liverpool, UK experienced in providing legal services for business and Commercial Litigations. Our lawyer team was highly skillful and talented; provide you the better service and success." />
    <meta name="keywords" content="commercial litigation solicitors in liverpool, commercial litigation solicitors liverpool, commercial litigation firm UK, business litigation, business lawyers liverpool, Solicitors in Liverpool UK" />
			...
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
                        ...
                        <p><img src="images/image_775x375.jpg" class="img-responsive" alt=""></p>
                      <p>Middleton Solicitors has extensive experience and expertise in all aspects of Commercial Litigation and Dispute Resolution.</p>
                      <p>We resolve business disputes through negotiation, mediation and litigation depending on the dispute. We give clear advice and work hard to understand our clients' business needs.</p>

                     <div class="clearfix"></div>

                        <ul class="service_li">
                        	<li> We offer the following services:</li>
                            <li>Director and Shareholder Disputes</li>
                            <li> Injunctions</li>
                            <li>Financial Seller Disputes</li>
                            <li>Mediation</li>
...
<uc1:popup ID="popup1" runat ="server" />
    ...
    <ul class="list-unstyled">
                    	<li><a href="commercial-law.aspx" title="Commercial Law" class="seractive01">Commercial Law</a></li>
                        <li><a href="debt-recovery.aspx" title="Debt Recovery">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
		...
		<div class="container">             
            <div class="row">
                ...
                <div class="col-sm-3 footer_li" id="tab_view">
                      <h2>How We Work</h2>
                    <ul class="list-unstyled">
                    	  <li><a href="commercial-law.aspx" title="Commercial Law" class="seractive">Commercial Law</a></li>
                        <li><a href="debt-recovery.aspx" title="Debt Recovery">Debt Recovery</a></li>
                        <li><a href="military-law.aspx" title="Military Law">Military Law</a></li>	
                    	<li><a href="personal-injury-claim.aspx" title="Personal Injury" >Personal Injury Claims</a></li>
                        <li><a href="recovering-payment-protection-insurance.aspx" title="Recovering Payment Protection Insurance "  >Recovering Payment Protection Insurance </a></li>
