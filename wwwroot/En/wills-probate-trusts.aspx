<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wills-probate-trusts.aspx.cs" Inherits="En_wills_probate_trusts" %>
...
<link rel="icon" href="images/favicon.ico" type="image/x-icon">
         ...
         <title>Middleton Solicitors - Wills and Probate Lawyers in Liverpool, United Kingdom</title>
          <meta name="description" content="Middleton Solicitors firm has expertise Wills and probate lawyers provides you the positive advice and personal service which helps to plan your future. Our highly experienced solicitors in liverpool are experts in all areas of trusts, wills and probate planning." />
    <meta name="keywords" content="Wills and probate solicitors liverpool, wills and probate lawyers liverpool, wills and probate services liverpool, wills and probate services in UK, wills and probate lawyers in UK" />
    ...
    <section id="container">
		...
		<div class="container">
			<div class="row">
                <div class="col-sm-8">
                    <div class="sideArea">
							 <h2>Wills, Probate and Trusts</h2>
                        <p><img src="images/service4.jpg" class="img-responsive" alt=""></p>
                        <!-- <b>Area of Law</b><br /><br />
                        <p>Probate & Wills & Trusts</p> -->
                        <B>Head of Department</B><br /><br />
                       <!-- <p>Robert Singleton</p>
                        ...
                        <b>Probate</b><br /><br />
                        <p align="justify">Probate is the name given to the procedure of the winding up of the Estate of somebody who has sadly passed away. When this happens, the Executor(s) of the Estate are under duty to carry out the administration of the Estate in accordance with the instructions left in the Will. The Executors will need to collect all of the required documentation and papers to make an application to the Probate Registry for a Grant of Representation which gives them the legal power and required proof to handle the affairs of the deceased's estate. If there was no will, or the will did not appoint Executors, the Probate Registry will upon receiving the relevant requirements, issue Letters of Administration to serve the same purpose of a Grant of Representation. Obtaining Probate can be a strenuous task particularly if the Estate is subject to Tax (which could be any or all of the following; Inheritance Tax, Capital Gains Tax & Income Tax). Middleton Solicitors can help you every step of the way in obtaining the Grant of Representation and dealing with the liquidation and distribution of the deceased's assets.</p>
                       <b>Wills & Trusts</b><br /><br />
                       <p align="justify">Although Death is something most of us do not want to think about, statistics show that less than 25% of the UK population have not drafted a will. You should consider making a will or a trust if you have assets and want them to go to the people you wish after your death.</p>
                       <div class="clearfix"></div>
                       <b>Things to consider</b><br />
                        <ul>                        		
  							    <li>You may have to pay Inheritance Tax,</li>
                                <li>You have a complicated family position,</li>
                                <li>You run a business.</li>
                               
                         </ul>
                         <p>Although it is true that wills can be drafted online, there are many advantages in using a solicitor to draft it for you:-</p>
                          <ul> 
                        		 <li>You are protected if something goes wrong,</li>        
  							    <li>The complicated bits can be done for you,</li>
                                <li>Your will is stored safely by a solicitor</li>
                                
                         </ul>
                     <%-- <p>Here at Middleton Solicitors we have a specialist team dealing with all aspects of the administration of Estates and Wills. We offer extremely competitive prices as well as a fast and efficient service.</p>
                      <p>For further information, or for a quote, on any of our legal services please contact us by one of the following methods, or alternatively please call in and speak to one of our advisors.</p>
                     <div class="clearfix"></div>

                       <ul class="service_li"><li>The main services we offer are:</li>
                            <li>Estate Administration</li>
                            <li>Grant Of Probate</li>
                            <li>Individual Wills</li>
                            <li>Joint Wills</li>
                            <li>Family Wills</li>
                            <li>Family Trusts</li>
                      ...
                      <p align="justify">For further information, or for a quote, on any of our legal services please contact us by one of the following methods or alternatively please call in and speak to one of our advisors.</p>
		...
		<div class="container">             
            <div class="row">
                <div class="col-sm-3 footer_ab" id="tab_view">
                    ...
                    <a href="about-us.aspx" class="btn btn-default">View More</a>
                </div>
                ...
                <div class="col-sm-3 footer_add footer_middle" id="tab_view">
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li>
                         ...
                         <li><a href="mailto:reception@middletonsolicitors.co.uk" title ="Cl"><i class="fa fa-envelope">  </i>reception@middletonsolicitors.co.uk</a></li>
