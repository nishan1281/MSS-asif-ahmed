<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Middleton_Specialist_Areas_Save.ascx.cs" Inherits="UserControls_Middleton_Specialist_Areas_Save" %>
...
<table style="float: left;margin-left: 150px;">
    <tr style="height: 60px;">   
        ...
        <td><asp:TextBox ID="txt_Tittle" class="form-control" runat="server" style="width:250px;"></asp:TextBox></td>
        <td rowspan ="3"><asp:Image ID="img_Spel" runat="server" Height =150px Width =300px Visible ="false"/></td>
    </tr>
    <tr>
        <td>Image</td><td>:</td>
    ...
    <tr style="height: 120px;">   
        ...
        <td><asp:TextBox ID="txt_SDesc" class="form-control" runat="server" 
                TextMode ="MultiLine" style="width:250px;"></asp:TextBox></td>
    </tr>    
    <tr>
        <td>Description</td><td>:</td>
        <td ><telerik:RadEditor ID="txt_Desc" runat="server" ToolbarMode="Floating" EditModes ="All">
                              </telerik:RadEditor>
          </td>
    </tr>
    ...
    <td></td><td></td>
        <td><asp:Button ID="btn_submit" class="btn btn-success" runat ="server" Text ="Submit" 
                ValidationGroup ="Sarea" CausesValidation ="true" onclick="btn_submit_Click"/></td>
    </tr>
    ...
    <tr>
        <td>
            ...
            ErrorMessage="Enter Specialist Area Title" ControlToValidate ="txt_Tittle" ValidationGroup ="Sarea"></asp:RequiredFieldValidator>
            
            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="None" 
            ErrorMessage="Upload Image" ControlToValidate ="fu_ImageUpload" ValidationGroup ="Sarea"></asp:RequiredFieldValidator>--%>
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="None" 
            ErrorMessage="Enter Short Description" ControlToValidate ="txt_SDesc" ValidationGroup ="Sarea"></asp:RequiredFieldValidator>
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="None" 
            ErrorMessage="Enter Description" ControlToValidate ="txt_Desc" ValidationGroup ="Sarea"></asp:RequiredFieldValidator>
            
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup ="Sarea"
...
<div style ="margin-left: -98px;">
        ...
        <Columns >
            ...
            <asp:BoundField  ItemStyle-Width ="150px" ItemStyle-Height ="27" DataField="Title" HeaderText="Title" > 
             ...
             <asp:BoundField  ItemStyle-Width ="70px" ItemStyle-Height ="27" DataField="Short_Desc" HeaderText="Short Description" > 
                    <ItemStyle Width ="70px" />
            </asp:BoundField>
            
             <asp:BoundField  ItemStyle-Width ="70px" ItemStyle-Height ="27" DataField="Description" HeaderText="Description" > 
                    <ItemStyle Width ="70px" />
            </asp:BoundField>
    ...
    <table width="90%" align="center" style="float: left;margin-left: 250px;">
         ...
         <tr>
              <td style="float:left;">
                  <div style="color:#067dba; font-weight: bold;width: 180px;"><asp:Label ID="lblPageInfo" runat="server" Text="Label"></asp:Label></div>
             </td>
              <td>
